...
#ifndef STASSID
#define STASSID "BLBLMK"//"Kasem"              //Name of the wifi that has both NodeMCU and laptop connected to
#define STAPSK  "B00L04B007K13"//"12345kkk"       //Wifi password
#endif
...
void loop() {
  ...
  String result2 =  String(Ax, 4) + "," + String(Ay, 4) + "," + String(Az, 4) + "," + String(Gx, 4) + "," + String(Gy, 4) + "," + String(Gz, 4) + ",";
